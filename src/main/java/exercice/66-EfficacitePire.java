...
public class Exercice {
    ...
    public static List<String> solution(String str, List<Character> ordre) {
        ...
        for (int i = 0; i < caracteres.length; i++) { // Parcourir chaque caractère du tableau de caractère (moins optimiser que la boucle foreach)
        ...
        if (str.isEmpty()) { // Si la chaine de caractère est vide
            ...
            for (int i = 0; i < ordre.size(); i++) { // Parcourir chaque caractère de la liste des caractères dans l'ordre
                ...
                for (int j = 0; j < motSepareList.size(); j++) { // Parcourir chaque mot de la liste des mots séparés
                    ...
                    if (motSep.charAt(0) == motOrd) { // Si le premier caractère du mot est égal au caractère dans l'ordre
...
// - La boucle for (int i = 0; i < caracteres.length; i++) { // Parcourir chaque caractère du tableau de caractère (moins optimiser que la boucle foreach)
// - La boucle for (int i = 0; i < ordre.size(); i++) { // Parcourir chaque caractère de la liste des caractères dans l'ordre
// Avec des boubles foreach, le code serait plus optimisé car il n'y aurait pas besoin de récupérer l'indice de l'élément dans la liste ou le tableau de caractère. 
